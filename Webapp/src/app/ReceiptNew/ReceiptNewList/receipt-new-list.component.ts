...
@Component({
    selector: 'app-receipt-new-list',
    templateUrl: './receipt-new-list.component.html',  
    providers: [ConfirmationService]
})

export class ReceiptNewListComponent implements OnInit {
  ...
  async Filter(){
    ...
    AddOrEditPurchase(receipt_id : any) {
        this.helper.redirectTo(`ReceiptNew/${receipt_id}`);
    }
...
const routes: Routes = [
    { path: "", component: ReceiptNewListComponent }
];
...
export class ReceiptNewListRoutingModule { }

@NgModule({
    declarations: [ReceiptNewListComponent],
    imports: [
        CommonModule,
        ReceiptNewListRoutingModule,
        ModuleData,
        TableModule,
        InputTextModule,
        ButtonModule,
...
export class ReceiptNewListModule { }
