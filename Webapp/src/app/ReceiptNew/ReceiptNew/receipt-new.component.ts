...
export class ReceiptNewComponent implements OnInit {
    ...
    AddNewRow(id)
    {
        if(id == 0)
        {
            this.NewStockEntryRow.push({
                serial_no :  this.NewStockEntryRow?.length + 1, code : "" , item : "" , quantity : 0 , gross_weight : 0.000 , other_weight : 0.000 , other_amount : 0.00,
                net_weight : 0.000 , melting : 0 , pure_weight : 0.000 , wastage : 0 , fine_weight : 0.000 , lab_rate : 0 , amount : 0.00 , mc_amount : 0.00
            })
        }
    }
...
const routes: Routes = [
    { path: "", component: ReceiptNewComponent }
];
...
export class ReceiptNewRoutingModule { }

@NgModule({
    declarations: [ReceiptNewComponent],
    imports: [
        CommonModule,
        ReceiptNewRoutingModule,
        ModuleData,
        DropdownModule,
        TableModule,
        ButtonModule,
